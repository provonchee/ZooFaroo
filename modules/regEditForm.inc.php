<div id="register-form">
  ...
  <div class="register-optionalInfo">
    ...
    <div class="register-optional"><img src="images/facebookFollow.png" height="25" width="25" alt="Find us on Facebook!" style="border:none;"/>&nbsp;&nbsp;&nbsp;&nbsp;<div class="register-preaddress">http://www.facebook.com/</div>
    <input name="facebook" id="facebook-input" type="text" class="input"  size="35" maxlength="35"/></div>
    
    <div class="register-optional"><img src="images/twitterFollow.png" height="25" width="25" alt="Follow us on Twitter!" style="border:none;"/>&nbsp;&nbsp;&nbsp;&nbsp;<div class="register-preaddress">http://www.twitter.com/</div>
    <input name="twitter" id="twitter-input" type="text" class="input"  size="35" maxlength="35"/></div>
    
    <div class="register-optional"><img src="images/googlePlusFollow.png" height="25" width="25" alt="Follow us on Google Plus!" style="border:none;"/>&nbsp;&nbsp;&nbsp;&nbsp;<div class="register-preaddress">https://plus.google.com/</div>
    <input name="google" id="google-input" type="text" class="input"  size="35" maxlength="35"/></div>
    
    <div class="register-optional"><img src="images/linkedinFollow.png" height="25" width="25" alt="Check us out on LinkedIn!" style="border:none;"/>&nbsp;&nbsp;&nbsp;&nbsp;<div class="register-preaddress">http://www.linkedin.com/</div>
    <input name="linkedin" id="linkedin-input" type="text" class="input"  size="35" maxlength="35"/></div>
    
    <div class="register-optional"><img src="images/websiteFollow.png" height="25" width="25" alt="My own website" style="border:none;"/>&nbsp;&nbsp;Your Own Website:&nbsp;&nbsp;&nbsp;&nbsp;<div class="register-preaddress">http://www.</div>
    ...
    <div class="register-optional"><img src="images/businessFollow.png" height="25" width="25" alt="I am a business" style="border:none;"/>&nbsp;&nbsp;Are you a business?
  	<input type="radio" name="business" class="business-input" value="2" /> yes&nbsp;&nbsp;<input type="radio" name="business" class="business-input" value="1"/> no<br/><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;If yes, what is your business name?<input name="busName" id="busName" type="text" class="input"  size="35" maxlength="60"/></div>
      
     <div class="register-optionalInfo">*If you do not wish to include an item simply leave the input blank.</div>
    </div>
