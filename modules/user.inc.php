...
<div id="review-form">
    ...
    <div id="reviews-recommend">How was your experience?</div><div id='ratePositive'><img src="images/plus.png"/><br/>positive&nbsp;<input type="radio" name="review-recommend" value="2"  checked></div><div id='rateNegative'><img src="images/minus.png"/><br/>negative &nbsp;<input type="radio" name="review-recommend" value="1"></div>
    <br/>
...
<? include_once('modules/reviewsEditInfo.inc.php'); ?>
