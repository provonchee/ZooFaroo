			...
			if($emailrow>0){
				...
				if($usernamerow>0){
					die('X13');//username already in use
						...
						mysql_query("INSERT INTO $tableName (email, username, password, randKey, secCode, city, state, business, facebook, twitter, google, linkedin, url) VALUES ($email, $username, $password, $randomKey, $superSec, $registerCity, $registerState, $business, $facebook, $twitter, $google, $linkedin, $url)") or die('X10');
