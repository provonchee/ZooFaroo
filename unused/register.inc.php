...
$('.regEditSubmitBtn').unbind('click').click(function(){
	...
	checkFormArray = {'City or Town':''+$('#city').val()+'',
			...
			function 	subMitRegisterForm(){			
	 		var form = new Array();
			form = {'di':'register','s1':''+$('#city').val()+'','e1':''+$('#email').val()+'','s2':''+$('#username-input').val()+'','s3':''+$('#password-input').val()+'','i1':''+drpDwnStateID+'', 'i2':''+$("input[name='business']:checked").val()+'','u1':''+fburl+'','u2':''+twyurl+'','u3':''+gourl+'', 'u4':''+lnurl+'', 'u5':''+addyurl+''};
											   ...
											   function(confirmation){
												  ...
												  if(confirmation=='psAlphaNum'){
													  ...
													  alertObject.alertBox('ALERT!', errorAlrt, 'gerrorPlus', buttonsReset, '.postBaseEdit', null);
														...
														$('#register-alert').empty();
														alertObject.alertBox('ALERT!', "Your username must be 5 to 12 characters long and contain no special characters.", 'gerrorPlus', buttonsReset, '.postBaseEdit', null);
